...
def non_unique_2d(info=dft):
    *info_1d, rows = info
    return [non_unique_1d(info_1d) for _ in range(rows)]
...
def unique_2d(info=dft):
    *info_1d, rows = info
    return [unique_1d(info_1d) for _ in range(rows)]
...
## Test
# rdict = {"non_unique_1d": non_unique_1d, "non_unique_2d": non_unique_2d, "unique_1d": unique_1d, "unique_2d": unique_2d}
